...
<%= request.getAttribute("filghtUpdate") %>
<tr>
	<th>날짜</th>
	<th>고유번호</th>
	<th>편명</th>
...
<form name ="flightUpView" action="FlightController" method="post">
<table>

	<tr><td> 수정하실 운항정보의 고유번호를 입력하세요 : <input type="text" name="updateNum"><input type="hidden" name="action" value="flightUpView"> <input type="submit" value="선택"></td>
	</tr>
</table>
</form>
</body>

...
public class FlightDao {
	...
	public ArrayList<FlightDto> FlightSelect(String leave, String arrive) {
		...
		String sql = "select * from flight where F_LEAVE = ? and F_ARRIVE = ?";

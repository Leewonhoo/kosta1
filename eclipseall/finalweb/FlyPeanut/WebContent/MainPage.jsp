...
<body>
	...
	<table width="100%">
		<tr style="font-size:22px; font-family:verdana,Courier,Monospace; text-decoration: none;">
			...
			<td bgcolor="#ffcc33" width="150px" height="80px" align="center"><a href = "UserMain.jsp">FlyPeanut</a></td>
		</tr>
	</table>
	<table>
		<tr>
			<td><img src="images/Seoul.JPG" width="377px" height="546px">
			</td>
			<td><img src="images/Busan.JPG" width="377px" height="546px">
			</td>
			<td><img src="images/Japan.JPG" width="377px" height="546px"></td>
			<td><img src="images/Moldiv.JPG" width="377px" height="546px">
			</td>
		</tr>
